    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (data==null){
            ...
            if (data.getPath().contains("/c/share/")){
                ...
                Log.i("ams", "onCreate: else test");
                try {

                    if(data.getQueryParameter("id" ).contains("channel")) {
                        this.id = Integer.parseInt(data.getQueryParameter("id").replace("channel", ""));
                        this.type = "channel";
                    }
                    else {
                    ...
                    Log.i("ams", "onCreate: else test  " + this.id);
                } catch (NumberFormatException e) {
                    Log.i("ams", "onCreate: exp  "+ e.getMessage());
