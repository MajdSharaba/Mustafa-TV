...
import com.alshawish.mustafatv.entity.Data;
import com.alshawish.mustafatv.ui.activities.ActorsActivity;
import com.alshawish.mustafatv.ui.activities.GenreActivity;
import com.alshawish.mustafatv.ui.activities.HomeActivity;
import com.alshawish.mustafatv.ui.activities.MyListActivity;
import com.alshawish.mustafatv.ui.activities.TopActivity;
...
public class HomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        Log.i("ams", "onCreateViewHolder: view HomeAdapter  " + viewType);
        switch (viewType) {
            case 0: {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder_parent, int position) {
        switch (getItemViewType(position)){
            ...
            case 2:
                ...
                this.channelAdapter =new ChannelAdapter(dataList.get(position).getChannels(),activity , "home");
            ...
            case 4:
              ...
              ////////update from linerManger to gridManger
                this.linearLayoutManagerGenreAdapter=  new GridLayoutManager(activity,3, RecyclerView.VERTICAL, false);
                ...
                holder_genres.recycle_view_posters_item_genre.setHasFixedSize(false);
