...
import com.alshawish.mustafatv.cast.ExpandedControlsActivity;
import com.alshawish.mustafatv.event.CastSessionEndedEvent;
import com.alshawish.mustafatv.event.CastSessionStartedEvent;
import com.alshawish.mustafatv.ui.player.CustomPlayerFragment;
...
public class PlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("ams", "onCreate: i am here");
        requestWindowFeature(Window.FEATURE_NO_TITLE);
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
        getWindow().setFlags(WindowManager.LayoutParams.FIRST_SUB_WINDOW,
