...
import com.alshawish.mustafatv.ui.activities.ChannelActivity;
...
public class ChannelAdapter  extends  RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ChannelAdapter(List<Channel> channelList, Activity activity , String source) {
    ...
    public  RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        Log.i("ams", "onCreateViewHolder:1231vv " + viewType + "  " + activity.getClass());
        switch (viewType) {
            case 1: {
                if(source.equals("home")) {
                    View v1 = inflater.inflate(R.layout.item_channel1, null);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder,final int position) {
        switch (getItemViewType(position)) {
            case 1:
                ...
                Picasso.with(activity).load(channelList.get(position).getImage()).placeholder(R.drawable.place_holder_channel).resize(150,150).into(holder.image_view_item_channel);
